...
```
1.申请GITHUB API Token（https://github.com/settings/personal-access-tokens）
2.配置需要添加环境变量环境变量GITHUB_MODEL_TOKEN
3.配置后才能使用AI功能(AI功能不包含上下文)

```

```
例如在macos上配置环境变量GITHUB_MODEL_TOKEN，值为github_pat_XXXXXX
cd ~
vim .bash_profile
